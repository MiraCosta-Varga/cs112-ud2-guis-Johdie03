...
public class transferSuccessfulController {
    ...
    protected void onContinueButtonClicked(ActionEvent actionEvent) throws IOException {
        ...
        System.out.println ("Current Total Checkings Amount after Transfer: " + ((Checkings) users[count - 2]).getTotalCheckingsAmount());
        System.out.println ("Current Total Savings Amount after Transfer: " + ((Savings) users[count - 1]).getTotalSavingsAmount());
    }
}
